...
location_table: Dict[str, KH1LocationData] = {
    ...
    "Traverse Town Geppetto's House Geppetto Reward 1":                                 KH1LocationData("Traverse Town",    265_6304, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward 4":                                 KH1LocationData("Traverse Town",    265_6305, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward 3":                                 KH1LocationData("Traverse Town",    265_6306, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward 5":                                 KH1LocationData("Traverse Town",    265_6307, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward 2":                                 KH1LocationData("Traverse Town",    265_6308, "Reward", True),
    "Traverse Town Geppetto's House Geppetto All Summons Reward":                       KH1LocationData("Traverse Town",    265_6309, "Reward", True),
    "Traverse Town Geppetto's House Talk to Pinocchio":                                 KH1LocationData("Traverse Town",    265_6310, "Reward", True),
    ...
    "Neverland Hold Aero Chest":                                                        KH1LocationData("Neverland",        265_6344, "Reward"),
    ...
    "Atlantica Sunken Ship Crystal Trident Event":                                      KH1LocationData("Atlantica",        265_6381, "Reward"),
    ...
    "Wonderland Lotus Forest Red Flowers on the Main Path":                             KH1LocationData("Wonderland",       265_6614, "Reward"),
    "Wonderland Lotus Forest Yellow Flowers in Middle Clearing and Through Painting":   KH1LocationData("Wonderland",       265_6615, "Reward"),
