...
location_table: Dict[str, KH1LocationData] = {
    ...
    "Atlantica Sunken Ship In Flipped Boat Chest":                                      KH1LocationData("Atlantica",        265_2531, "Chest"),
    "Atlantica Sunken Ship Seabed Chest":                                               KH1LocationData("Atlantica",        265_2532, "Chest"),
    "Atlantica Sunken Ship Inside Ship Chest":                                          KH1LocationData("Atlantica",        265_2533, "Chest"),
    "Atlantica Ariel's Grotto High Chest":                                              KH1LocationData("Atlantica",        265_2534, "Chest"),
    "Atlantica Ariel's Grotto Middle Chest":                                            KH1LocationData("Atlantica",        265_2571, "Chest"),
    "Atlantica Ariel's Grotto Low Chest":                                               KH1LocationData("Atlantica",        265_2572, "Chest"),
    "Atlantica Ursula's Lair Use Fire on Urchin Chest":                                 KH1LocationData("Atlantica",        265_2573, "Chest",  True),
    "Atlantica Undersea Gorge Jammed by Ariel's Grotto Chest":                          KH1LocationData("Atlantica",        265_2574, "Chest"),
    "Atlantica Triton's Palace White Trinity Chest":                                    KH1LocationData("Atlantica",        265_2611, "Chest"),
    ...
    "Hollow Bastion Library 1st Floor Turn the Carousel Chest":                         KH1LocationData("Hollow Bastion",   265_4214, "Chest",  True),
    "Hollow Bastion Library Top of Bookshelf Turn the Carousel Chest":                  KH1LocationData("Hollow Bastion",   265_4251, "Chest",  True),
    "Hollow Bastion Library 2nd Floor Turn the Carousel 1st Chest":                     KH1LocationData("Hollow Bastion",   265_4252, "Chest",  True),
    "Hollow Bastion Library 2nd Floor Turn the Carousel 2nd Chest":                     KH1LocationData("Hollow Bastion",   265_4253, "Chest",  True),
    ...
    "End of the World World Terminus Atlantica Chest":                                  KH1LocationData("End of the World", 265_4731, "Chest",  True),
    ...
    "Traverse Town Defeat Guard Armor Fire Event":                                      KH1LocationData("Traverse Town",    265_6012, "Reward"),
    "Traverse Town Defeat Guard Armor Blue Trinity Event":                              KH1LocationData("Traverse Town",    265_6013, "Reward"),
    ...
    "Traverse Town Defeat Guard Armor 500 Munny Reward":                                KH1LocationData("Traverse Town",    265_6017, "Reward"),
    "Deep Jungle Defeat Sabor White Fang Event":                                        KH1LocationData("Deep Jungle",      265_6021, "Reward", True),
    "Deep Jungle Defeat Clayton Cure Event":                                            KH1LocationData("Deep Jungle",      265_6022, "Reward", True),
    "Deep Jungle Seal Keyhole Jungle King Event":                                       KH1LocationData("Deep Jungle",      265_6023, "Reward", True),
    "Deep Jungle Seal Keyhole Red Trinity Event":                                       KH1LocationData("Deep Jungle",      265_6024, "Reward", True),
    "Olympus Coliseum Clear Phil's Training Thunder Event":                             KH1LocationData("Olympus Coliseum", 265_6031, "Reward"),
    "Olympus Coliseum Defeat Cerberus Inferno Band Event":                              KH1LocationData("Olympus Coliseum", 265_6033, "Reward", True),
    "Wonderland Defeat Trickmaster Blizzard Event":                                     KH1LocationData("Wonderland",       265_6041, "Reward", True),
    ...
    "Agrabah Defeat Jafar Blizzard Event":                                              KH1LocationData("Agrabah",          265_6052, "Reward", True),
    "Agrabah Defeat Jafar Genie Fire Event":                                            KH1LocationData("Agrabah",          265_6053, "Reward", True),
    "Agrabah Seal Keyhole Genie Event":                                                 KH1LocationData("Agrabah",          265_6054, "Reward", True),
    "Agrabah Seal Keyhole Three Wishes Event":                                          KH1LocationData("Agrabah",          265_6055, "Reward", True),
    "Agrabah Seal Keyhole Green Trinity Event":                                         KH1LocationData("Agrabah",          265_6056, "Reward", True),
    "Monstro Defeat Parasite Cage I Goofy Cheer Event":                                 KH1LocationData("Monstro",          265_6061, "Reward", True),
    "Monstro Defeat Parasite Cage II Stop Event":                                       KH1LocationData("Monstro",          265_6062, "Reward", True),
    "Atlantica Defeat Ursula I Mermaid Kick Event":                                     KH1LocationData("Atlantica",        265_6071, "Reward", True),
    "Atlantica Defeat Ursula II Thunder Event":                                         KH1LocationData("Atlantica",        265_6072, "Reward", True),
    ...
    "Halloween Town Defeat Oogie's Manor Gravity Event":                                KH1LocationData("Halloween Town",   265_6082, "Reward", True),
    ...
    "Neverland Encounter Hook Cure Event":                                              KH1LocationData("Neverland",        265_6092, "Reward", True),
    "Neverland Seal Keyhole Fairy Harp Event":                                          KH1LocationData("Neverland",        265_6093, "Reward", True),
    "Neverland Seal Keyhole Tinker Bell Event":                                         KH1LocationData("Neverland",        265_6094, "Reward", True),
    "Neverland Seal Keyhole Glide Event":                                               KH1LocationData("Neverland",        265_6095, "Reward", True),
    "Neverland Defeat Phantom Stop Event":                                              KH1LocationData("Neverland",        265_6096, "Reward", True),
    "Neverland Defeat Captain Hook Ars Arcanum Event":                                  KH1LocationData("Neverland",        265_6097, "Reward", True),
    "Hollow Bastion Defeat Riku I White Trinity Event":                                 KH1LocationData("Hollow Bastion",   265_6101, "Reward", True),
    ...
    "Hollow Bastion Speak to Princesses Fire Event":                                    KH1LocationData("Hollow Bastion",   265_6106, "Reward", True),
    "End of the World Defeat Chernabog Superglide Event":                               KH1LocationData("End of the World", 265_6111, "Reward", True),
    "Neverland Seal Keyhole Navi-G Piece Event":                                        KH1LocationData("Neverland",        265_6112, "Reward", True),
    "Traverse Town Secret Waterway Navi Gummi Event":                                   KH1LocationData("Traverse Town",    265_6113, "Reward", True),
    "Traverse Town Magician's Study Earthshine Event":                                  KH1LocationData("Traverse Town",    265_6114, "Reward"),
    "Traverse Town Magician's Study Naturespark Event":                                 KH1LocationData("Traverse Town",    265_6115, "Reward"),
    "Traverse Town Magician's Study Watergleam Event":                                  KH1LocationData("Traverse Town",    265_6116, "Reward"),
    "Traverse Town Magician's Study Fireglow Event":                                    KH1LocationData("Traverse Town",    265_6117, "Reward"),
    "Traverse Town Magician's Study Lord Fortune Event":                                KH1LocationData("Traverse Town",    265_6118, "Reward"),
    ...
    "Traverse Town Defeat Opposite Armor Aero Event":                                   KH1LocationData("Traverse Town",    265_6131, "Reward", True),
    "Traverse Town Defeat Opposite Armor Navi-G Piece Event":                           KH1LocationData("Traverse Town",    265_6132, "Reward", True),
    
    "Atlantica Undersea Gorge Blizzard Clam":                                           KH1LocationData("Atlantica",        265_6201, "Reward"),
    "Atlantica Undersea Gorge Ocean Floor Clam":                                        KH1LocationData("Atlantica",        265_6202, "Reward"),
    "Atlantica Undersea Valley Higher Cave Clam":                                       KH1LocationData("Atlantica",        265_6203, "Reward"),
    "Atlantica Undersea Valley Lower Cave Clam":                                        KH1LocationData("Atlantica",        265_6204, "Reward"),
    "Atlantica Undersea Valley Fire Clam":                                              KH1LocationData("Atlantica",        265_6205, "Reward"),
    "Atlantica Undersea Valley Wall Clam":                                              KH1LocationData("Atlantica",        265_6206, "Reward"),
    "Atlantica Undersea Valley Pillar Clam":                                            KH1LocationData("Atlantica",        265_6207, "Reward"),
    "Atlantica Undersea Valley Ocean Floor Clam":                                       KH1LocationData("Atlantica",        265_6208, "Reward"),
    "Atlantica Triton's Palace Thunder Clam":                                           KH1LocationData("Atlantica",        265_6209, "Reward"),
    "Atlantica Triton's Palace Wall Right Clam":                                        KH1LocationData("Atlantica",        265_6210, "Reward"),
    "Atlantica Triton's Palace Near Path Clam":                                         KH1LocationData("Atlantica",        265_6211, "Reward"),
    "Atlantica Triton's Palace Wall Left Clam":                                         KH1LocationData("Atlantica",        265_6212, "Reward"),
    "Atlantica Cavern Nook Clam":                                                       KH1LocationData("Atlantica",        265_6213, "Reward"),
    "Atlantica Below Deck Clam":                                                        KH1LocationData("Atlantica",        265_6214, "Reward"),
    "Atlantica Undersea Garden Clam":                                                   KH1LocationData("Atlantica",        265_6215, "Reward"),
    "Atlantica Undersea Cave Clam":                                                     KH1LocationData("Atlantica",        265_6216, "Reward"),
    
    "Traverse Town Geppetto's House Geppetto Reward Cid Blueprint":                     KH1LocationData("Traverse Town",    265_6303, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Geppetto Blueprint":                KH1LocationData("Traverse Town",    265_6304, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Aerith Blueprint":                  KH1LocationData("Traverse Town",    265_6305, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Yuffie Blueprint":                  KH1LocationData("Traverse Town",    265_6306, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Leon Blueprint":                    KH1LocationData("Traverse Town",    265_6307, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Cactaur Blueprint":                 KH1LocationData("Traverse Town",    265_6308, "Reward", True),
    "Traverse Town Geppetto's House Geppetto Reward Hyperion Blueprint":                KH1LocationData("Traverse Town",    265_6309, "Reward", True),
    "Traverse Town Geppetto's House Pinocchio Reward Chocobo Blueprint":                KH1LocationData("Traverse Town",    265_6310, "Reward", True),
    ...
    "Traverse Town Piano Room Return 10 Puppies":                                       KH1LocationData("Traverse Town",    265_6314, "Reward"),
    "Traverse Town Piano Room Return 20 Puppies":                                       KH1LocationData("Traverse Town",    265_6315, "Reward"),
    "Traverse Town Piano Room Return 30 Puppies":                                       KH1LocationData("Traverse Town",    265_6316, "Reward"),
    "Traverse Town Piano Room Return 40 Puppies":                                       KH1LocationData("Traverse Town",    265_6317, "Reward"),
    "Traverse Town Piano Room Return 50 Puppies Reward 1":                              KH1LocationData("Traverse Town",    265_6318, "Reward"),
    ...
    "Traverse Town Piano Room Return 80 Puppies":                                       KH1LocationData("Traverse Town",    265_6322, "Reward"),
    "Traverse Town Piano Room Return 90 Puppies":                                       KH1LocationData("Traverse Town",    265_6324, "Reward"),
    "Traverse Town Piano Room Return 99 Puppies Reward 1":                              KH1LocationData("Traverse Town",    265_6326, "Reward"),
    "Traverse Town Piano Room Return 99 Puppies Reward 2":                              KH1LocationData("Traverse Town",    265_6327, "Reward"),
    "Olympus Coliseum Cloud Sonic Blade Event":                                         KH1LocationData("Olympus Coliseum", 265_6032, "Reward", True),
    ...
    "Olympus Coliseum Gates Purple Jar After Defeating Hades":                          KH1LocationData("Olympus Coliseum", 265_6330, "Reward", True),
    "Halloween Town Guillotine Square Ring Jack's Doorbell 3 Times":                    KH1LocationData("Halloween Town",   265_6331, "Reward"),
    "Neverland Clock Tower 01:00 Door":                                                 KH1LocationData("Neverland",        265_6332, "Reward", True),
    "Neverland Clock Tower 02:00 Door":                                                 KH1LocationData("Neverland",        265_6333, "Reward", True),
    "Neverland Clock Tower 03:00 Door":                                                 KH1LocationData("Neverland",        265_6334, "Reward", True),
    "Neverland Clock Tower 04:00 Door":                                                 KH1LocationData("Neverland",        265_6335, "Reward", True),
    "Neverland Clock Tower 05:00 Door":                                                 KH1LocationData("Neverland",        265_6336, "Reward", True),
    "Neverland Clock Tower 06:00 Door":                                                 KH1LocationData("Neverland",        265_6337, "Reward", True),
    "Neverland Clock Tower 07:00 Door":                                                 KH1LocationData("Neverland",        265_6338, "Reward", True),
    "Neverland Clock Tower 08:00 Door":                                                 KH1LocationData("Neverland",        265_6339, "Reward", True),
    "Neverland Clock Tower 09:00 Door":                                                 KH1LocationData("Neverland",        265_6340, "Reward", True),
    "Neverland Clock Tower 10:00 Door":                                                 KH1LocationData("Neverland",        265_6341, "Reward", True),
    "Neverland Clock Tower 11:00 Door":                                                 KH1LocationData("Neverland",        265_6342, "Reward", True),
    "Neverland Clock Tower 12:00 Door":                                                 KH1LocationData("Neverland",        265_6343, "Reward", True),
    "Neverland Hold Aero Chest":                                                        KH1LocationData("Neverland",        265_6344, "Chest"),
    "100 Acre Wood Bouncing Spot Turn in Rare Nut 1":                                   KH1LocationData("100 Acre Wood",    265_6345, "Reward"),
    "100 Acre Wood Bouncing Spot Turn in Rare Nut 2":                                   KH1LocationData("100 Acre Wood",    265_6346, "Reward"),
    "100 Acre Wood Bouncing Spot Turn in Rare Nut 3":                                   KH1LocationData("100 Acre Wood",    265_6347, "Reward"),
    "100 Acre Wood Bouncing Spot Turn in Rare Nut 4":                                   KH1LocationData("100 Acre Wood",    265_6348, "Reward"),
    "100 Acre Wood Bouncing Spot Turn in Rare Nut 5":                                   KH1LocationData("100 Acre Wood",    265_6349, "Reward"),
    ...
    "100 Acre Wood Convert Torn Page 3":                                                KH1LocationData("100 Acre Wood",    265_6353, "Reward"),
    ...
    "100 Acre Wood Pooh's House Start Fire":                                            KH1LocationData("100 Acre Wood",    265_6356, "Reward"),
    "100 Acre Wood Pooh's Room Cabinet":                                                KH1LocationData("100 Acre Wood",    265_6357, "Reward"),
    "100 Acre Wood Pooh's Room Chimney":                                                KH1LocationData("100 Acre Wood",    265_6358, "Reward"),
    "100 Acre Wood Bouncing Spot Break Log":                                            KH1LocationData("100 Acre Wood",    265_6359, "Reward"),
    "100 Acre Wood Bouncing Spot Fall Through Top of Tree Next to Pooh":                KH1LocationData("100 Acre Wood",    265_6360, "Reward"),
    "Deep Jungle Camp Hi-Potion Experiment":                                            KH1LocationData("Deep Jungle",      265_6361, "Reward"),
    "Deep Jungle Camp Ether Experiment":                                                KH1LocationData("Deep Jungle",      265_6362, "Reward"),
    "Deep Jungle Camp Replication Experiment":                                          KH1LocationData("Deep Jungle",      265_6363, "Reward"),
    "Deep Jungle Cliff Save Gorillas":                                                  KH1LocationData("Deep Jungle",      265_6364, "Reward"),
    "Deep Jungle Tree House Save Gorillas":                                             KH1LocationData("Deep Jungle",      265_6365, "Reward"),
    "Deep Jungle Camp Save Gorillas":                                                   KH1LocationData("Deep Jungle",      265_6366, "Reward"),
    "Deep Jungle Bamboo Thicket Save Gorillas":                                         KH1LocationData("Deep Jungle",      265_6367, "Reward"),
    "Deep Jungle Climbing Trees Save Gorillas":                                         KH1LocationData("Deep Jungle",      265_6368, "Reward"),
    ...
    "Traverse Town 1st District Speak with Cid Event":                                  KH1LocationData("Traverse Town",    265_6375, "Reward"),
    "Wonderland Bizarre Room Read Book":                                                KH1LocationData("Wonderland",       265_6376, "Reward"),
    "Olympus Coliseum Coliseum Gates Green Trinity":                                    KH1LocationData("Olympus Coliseum", 265_6377, "Reward"),
    ...
    "Olympus Coliseum Coliseum Gates Hero's License Event":                             KH1LocationData("Olympus Coliseum", 265_6380, "Reward", True),
    "Atlantica Sunken Ship Crystal Trident Event":                                      KH1LocationData("Atlantica",        265_6381, "Chest"),
    "Halloween Town Graveyard Forget-Me-Not Event":                                     KH1LocationData("Halloween Town",   265_6382, "Reward"),
    "Deep Jungle Tent Protect-G Event":                                                 KH1LocationData("Deep Jungle",      265_6383, "Reward"),
    "Deep Jungle Cavern of Hearts Navi-G Piece Event":                                  KH1LocationData("Deep Jungle",      265_6384, "Reward", True),
    "Wonderland Bizarre Room Navi-G Piece Event":                                       KH1LocationData("Wonderland",       265_6385, "Reward", True),
    "Olympus Coliseum Coliseum Gates Entry Pass Event":                                 KH1LocationData("Olympus Coliseum", 265_6386, "Reward"),
    "Deep Jungle Camp Slide 1":                                                         KH1LocationData("Deep Jungle",      265_6387, "Reward"),
    "Deep Jungle Camp Slide 2":                                                         KH1LocationData("Deep Jungle",      265_6388, "Reward"),
    "Deep Jungle Camp Slide 3":                                                         KH1LocationData("Deep Jungle",      265_6389, "Reward"),
    "Deep Jungle Camp Slide 4":                                                         KH1LocationData("Deep Jungle",      265_6390, "Reward"),
    "Deep Jungle Camp Slide 5":                                                         KH1LocationData("Deep Jungle",      265_6391, "Reward"),
    "Deep Jungle Camp Slide 6":                                                         KH1LocationData("Deep Jungle",      265_6392, "Reward"),
    "Wonderland Footprints Evidence Box":                                               KH1LocationData("Wonderland",       265_6393, "Chest"),
    "Wonderland Claw Marks Evidence Box":                                               KH1LocationData("Wonderland",       265_6394, "Chest"),
    "Wonderland Stench Evidence Box":                                                   KH1LocationData("Wonderland",       265_6395, "Chest"),
    "Wonderland Antenna Evidence Box":                                                  KH1LocationData("Wonderland",       265_6396, "Chest"),
    ...
    "Traverse Town Item Shop Postcard":                                                 KH1LocationData("Traverse Town",    265_6500, "Reward"),
    "Traverse Town 1st District Safe Postcard":                                         KH1LocationData("Traverse Town",    265_6501, "Reward"),
    "Traverse Town Gizmo Shop Postcard 1":                                              KH1LocationData("Traverse Town",    265_6502, "Reward"),
    "Traverse Town Gizmo Shop Postcard 2":                                              KH1LocationData("Traverse Town",    265_6503, "Reward"),
    "Traverse Town Item Workshop Postcard":                                             KH1LocationData("Traverse Town",    265_6504, "Reward"),
    "Traverse Town 3rd District Balcony Postcard":                                      KH1LocationData("Traverse Town",    265_6505, "Reward"),
    "Traverse Town Geppetto's House Postcard":                                          KH1LocationData("Traverse Town",    265_6506, "Reward", True),
    "Halloween Town Lab Torn Page":                                                     KH1LocationData("Halloween Town",   265_6508, "Reward"),
    "Hollow Bastion Entrance Hall Emblem Piece (Flame)":                                KH1LocationData("Hollow Bastion",   265_6516, "Reward", True),
    "Hollow Bastion Entrance Hall Emblem Piece (Chest)":                                KH1LocationData("Hollow Bastion",   265_6517, "Chest",  True),
    "Hollow Bastion Entrance Hall Emblem Piece (Statue)":                               KH1LocationData("Hollow Bastion",   265_6518, "Reward", True),
    "Hollow Bastion Entrance Hall Emblem Piece (Fountain)":                             KH1LocationData("Hollow Bastion",   265_6519, "Reward", True),
    ...
    "Hollow Bastion Library Speak to Aerith Cure":                                      KH1LocationData("Hollow Bastion",   265_6523, "Reward", True),
    
    "Traverse Town 1st District Blue Trinity by Exit Door":                             KH1LocationData("Traverse Town",    265_6600, "Reward"),
    "Traverse Town 3rd District Blue Trinity":                                          KH1LocationData("Traverse Town",    265_6601, "Reward"),
    "Traverse Town Magician's Study Blue Trinity":                                      KH1LocationData("Traverse Town",    265_6602, "Reward"),
    "Wonderland Lotus Forest Blue Trinity in Alcove":                                   KH1LocationData("Wonderland",       265_6603, "Reward"),
    "Wonderland Lotus Forest Blue Trinity by Moving Boulder":                           KH1LocationData("Wonderland",       265_6604, "Reward"),
    "Agrabah Bazaar Blue Trinity":                                                      KH1LocationData("Agrabah",          265_6605, "Reward"),
    "Monstro Mouth Blue Trinity":                                                       KH1LocationData("Monstro",          265_6606, "Reward",  True),
    "Monstro Chamber 5 Blue Trinity":                                                   KH1LocationData("Monstro",          265_6607, "Reward"),
    "Hollow Bastion Great Crest Blue Trinity":                                          KH1LocationData("Hollow Bastion",   265_6608, "Reward",  True),
    "Hollow Bastion Dungeon Blue Trinity":                                              KH1LocationData("Hollow Bastion",   265_6609, "Reward",  True),
    "Deep Jungle Treetop Green Trinity":                                                KH1LocationData("Deep Jungle",      265_6610, "Reward"),
    "Agrabah Cave of Wonders Treasure Room Red Trinity":                                KH1LocationData("Agrabah",          265_6611, "Reward",  True),
    "Monstro Throat Blue Trinity":                                                      KH1LocationData("Monstro",          265_6612, "Reward",  True),
    "Wonderland Bizarre Room Examine Flower Pot":                                       KH1LocationData("Wonderland",       265_6613, "Reward"),
    "Wonderland Lotus Forest Red Ether Flower Across from Queen's Castle":              KH1LocationData("Wonderland",       265_6614, "Reward"),
    "Wonderland Lotus Forest Yellow Potion Flower in Center Alcove":                    KH1LocationData("Wonderland",       265_6615, "Reward"),
    "Wonderland Lotus Forest Yellow Elixir Flower Through Painting":                    KH1LocationData("Wonderland",       265_6616, "Reward"),
    "Wonderland Lotus Forest Red Flower Raise Lily Pads":                               KH1LocationData("Wonderland",       265_6617, "Reward"),
    "Wonderland Tea Party Garden Left Cushioned Chair":                                 KH1LocationData("Wonderland",       265_6618, "Reward"),
    "Wonderland Tea Party Garden Left Pink Chair":                                      KH1LocationData("Wonderland",       265_6619, "Reward"),
    "Wonderland Tea Party Garden Right Yellow Chair":                                   KH1LocationData("Wonderland",       265_6620, "Reward"),
    "Wonderland Tea Party Garden Left Gray Chair":                                      KH1LocationData("Wonderland",       265_6621, "Reward"),
    "Wonderland Tea Party Garden Right Brown Chair":                                    KH1LocationData("Wonderland",       265_6622, "Reward"),
    "Hollow Bastion Lift Stop from Waterway Examine Node":                              KH1LocationData("Hollow Bastion",   265_6623, "Reward",  True),
    "Wonderland Lotus Forest Yellow Potion Flower Through Painting":                    KH1LocationData("Wonderland",       265_6624, "Reward"),
    "Wonderland Lotus Forest Red Ether Flower Along Wall":                              KH1LocationData("Wonderland",       265_6625, "Reward"),
    
    "Destiny Islands Seashore Capture Fish 1 (Day 2)":                                  KH1LocationData("Destiny Islands",  265_6700, "Reward"),
    "Destiny Islands Seashore Capture Fish 2 (Day 2)":                                  KH1LocationData("Destiny Islands",  265_6701, "Reward"),
    "Destiny Islands Seashore Capture Fish 3 (Day 2)":                                  KH1LocationData("Destiny Islands",  265_6702, "Reward"),
    "Destiny Islands Seashore Gather Seagull Egg (Day 2)":                              KH1LocationData("Destiny Islands",  265_6703, "Reward"),
    "Destiny Islands Seashore Log on Riku's Island (Day 1)":                            KH1LocationData("Destiny Islands",  265_6704, "Reward"),
    "Destiny Islands Seashore Log under Bridge (Day 1)":                                KH1LocationData("Destiny Islands",  265_6705, "Reward"),
    "Destiny Islands Seashore Gather Cloth (Day 1)":                                    KH1LocationData("Destiny Islands",  265_6706, "Reward"),
    "Destiny Islands Seashore Gather Rope (Day 1)":                                     KH1LocationData("Destiny Islands",  265_6707, "Reward"),
    "Destiny Islands Secret Place Gather Mushroom (Day 2)":                             KH1LocationData("Destiny Islands",  265_6711, "Reward"),
    "Destiny Islands Cove Gather Mushroom Near Zip Line (Day 2)":                       KH1LocationData("Destiny Islands",  265_6712, "Reward"),
    "Destiny Islands Cove Gather Mushroom in Small Cave (Day 2)":                       KH1LocationData("Destiny Islands",  265_6713, "Reward"),
    ...
    "Destiny Islands Cove Race Riku (Day 2)":                                           KH1LocationData("Destiny Islands",  265_5105, "Reward"),
    "Destiny Islands Cove Talk to Kairi Potion Reward (Day 2)":                         KH1LocationData("Destiny Islands",  265_5106, "Reward"),
    "Destiny Islands Cove Talk to Kairi Hi-Potion Reward (Day 2)":                      KH1LocationData("Destiny Islands",  265_5107, "Reward"),
    ...
    "Agrabah Defeat Jafar Genie Ansem's Report 1":                                      KH1LocationData("Agrabah",          265_7018, "Reward", True),
    "Hollow Bastion Speak with Aerith Ansem's Report 2":                                KH1LocationData("Hollow Bastion",   265_7017, "Reward", True),
    "Atlantica Defeat Ursula II Ansem's Report 3":                                      KH1LocationData("Atlantica",        265_7016, "Reward", True),
    "Hollow Bastion Speak with Aerith Ansem's Report 4":                                KH1LocationData("Hollow Bastion",   265_7015, "Reward", True),
    "Hollow Bastion Defeat Maleficent Ansem's Report 5":                                KH1LocationData("Hollow Bastion",   265_7014, "Reward", True),
    "Hollow Bastion Speak with Aerith Ansem's Report 6":                                KH1LocationData("Hollow Bastion",   265_7013, "Reward", True),
    "Halloween Town Defeat Oogie Boogie Ansem's Report 7":                              KH1LocationData("Halloween Town",   265_7012, "Reward", True),
    "Olympus Coliseum Defeat Hades Ansem's Report 8":                                   KH1LocationData("Olympus Coliseum", 265_7011, "Reward", True),
    "Neverland Defeat Hook Ansem's Report 9":                                           KH1LocationData("Neverland",        265_7028, "Reward", True),
    "Hollow Bastion Speak with Aerith Ansem's Report 10":                               KH1LocationData("Hollow Bastion",   265_7027, "Reward", True),
    "Agrabah Defeat Kurt Zisa Ansem's Report 11":                                       KH1LocationData("Agrabah",          265_7026, "Reward", True),
    "Olympus Coliseum Defeat Sephiroth Ansem's Report 12":                              KH1LocationData("Olympus Coliseum", 265_7025, "Reward", True),
    "Hollow Bastion Defeat Unknown Ansem's Report 13":                                  KH1LocationData("Hollow Bastion",   265_7024, "Reward", True),
    ...
    "Complete Phil Cup":                                                                KH1LocationData("Olympus Coliseum", 265_9001, "Reward", True),
    ...
    "Hades Cup Defeat Cerberus Event":                                                  KH1LocationData("Olympus Coliseum", 265_9015, "Reward", True),
    "Hades Cup Defeat Behemoth Event":                                                  KH1LocationData("Olympus Coliseum", 265_9016, "Reward", True),
    "Hades Cup Defeat Hades Event":                                                     KH1LocationData("Olympus Coliseum", 265_9017, "Reward", True),
    "Hercules Cup Defeat Cloud Event":                                                  KH1LocationData("Olympus Coliseum", 265_9018, "Reward", True),
    "Hercules Cup Yellow Trinity Event":                                                KH1LocationData("Olympus Coliseum", 265_9019, "Reward", True),
