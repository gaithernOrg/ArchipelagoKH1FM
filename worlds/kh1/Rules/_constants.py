...
EMBLEM_PIECES = ("Emblem Piece (Flame)", "Emblem Piece (Chest)", "Emblem Piece (Statue)",
                 "Emblem Piece (Fountain)", "Hollow Bastion")
HJ_GLIDE = ("High Jump", "Progressive Glide")
DODGE_AIRGUARD = ("Dodge Roll", "Air Guard/Dodge Roll")
THREE_CUPS = ("Phil Cup", "Pegasus Cup", "Hercules Cup")
