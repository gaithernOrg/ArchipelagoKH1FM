...
kh1_option_presets: Dict[str, Dict[str, Any]] = {
    ...
    "Final Ansem": {
        ...
        "skip_hundred_acre_wood_minigames": False,
        "cups_standard": CupsStandard.option_normal,
        "cups_solo_time_trial": CupsSoloTimeTrial.option_same_as_standard,
        "jungle_slider": False,
