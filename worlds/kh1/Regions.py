...
def create_regions(kh1world):
    ...
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 1")
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 2")
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 3")
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 4")
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 5")
    regions["Deep Jungle"].locations.append("Deep Jungle Camp Slide 6")
    ...
    regions["Traverse Town"].locations.append("Traverse Town Defeat Guard Armor 500 Munny Reward")
    ...
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Aerith Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Cactaur Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Cid Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Geppetto Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Hyperion Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Leon Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Geppetto Reward Yuffie Blueprint")
    regions["Traverse Town"].locations.append("Traverse Town Geppetto's House Pinocchio Reward Chocobo Blueprint")
    ...
    regions["Traverse Town"].locations.append("Traverse Town Magician's Study Earthshine Event")
    regions["Traverse Town"].locations.append("Traverse Town Magician's Study Naturespark Event")
    regions["Traverse Town"].locations.append("Traverse Town Magician's Study Watergleam Event")
    regions["Traverse Town"].locations.append("Traverse Town Magician's Study Fireglow Event")
    regions["Traverse Town"].locations.append("Traverse Town Magician's Study Lord Fortune Event")
    ...
    regions["Wonderland"].locations.append("Wonderland Footprints Evidence Box")
    regions["Wonderland"].locations.append("Wonderland Claw Marks Evidence Box")
    regions["Wonderland"].locations.append("Wonderland Stench Evidence Box")
    regions["Wonderland"].locations.append("Wonderland Antenna Evidence Box")
    ...
    regions["Wonderland"].locations.append("Wonderland Lotus Forest Red Ether Flower Across from Queen's Castle")
    ...
    regions["Wonderland"].locations.append("Wonderland Lotus Forest Yellow Potion Flower in Center Alcove")
    regions["Wonderland"].locations.append("Wonderland Lotus Forest Yellow Potion Flower Through Painting")
    ...
    regions["Wonderland"].locations.append("Wonderland Lotus Forest Red Ether Flower Along Wall")
    ...
    if options.destiny_islands:
        ...
        regions["Destiny Islands"].locations.append("Destiny Islands Cove Race Riku (Day 2)")
        regions["Destiny Islands"].locations.append("Destiny Islands Cove Talk to Kairi Potion Reward (Day 2)")
        regions["Destiny Islands"].locations.append("Destiny Islands Cove Talk to Kairi Hi-Potion Reward (Day 2)")
